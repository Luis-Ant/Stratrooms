...
import Bold from "../assets/icons/letter-bold.svg";
import Italic from "../assets/icons/letter-italic.svg";
import Under from "../assets/icons/letter-underline.svg";
...
import Point from "../assets/icons/dots-vertical.svg";
...
const CourseContent = ({ course, onBack }) => {
  ...
  if (!course || typeof course !== 'object') {
    return (
      <div className="p-4">
        <p className="text-red-500">Error: No se proporcionó información del curso.</p>
      </div>
    );
  }
          ...
          <div className="w-1/3 text-left">
            ...
            {activeTab === 'school grades' && (
              <div className="text-left">
                ...
                {course?.schoolGrades ? (
                  Object.entries(course.schoolGrades).map(([student, grade], index) => (
                    <div
                      key={index}
                      className="bg-gray-100 p-4 rounded-lg mb-2 flex justify-start"
                    >
              ...
              {activeTab === 'posts' && (
                <div className="bg-gray-100 p-4 rounded-lg mb-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    >
                      <img className="w-5 h-5 mr-[2px]" src={Close} alt="close" />
                    </button>
                  </div>
                    ...
                    <>
                      <div className="flex space-x-2 mb-2">
                        <button
                          ...
                          title="Bold"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={Bold} alt="bold" />
                        </button>
                        <button
                          onClick={applyItalic}
                          className="p-1 text-gray-600 hover:bg-gray-200 rounded"
                          title="Italic"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={Italic} alt="italic" />
                        </button>
                        <button
                          onClick={applyList}
                          className="p-1 text-gray-600 hover:bg-gray-200 rounded"
                          title="Underline"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={Under} alt="underline" />
                        </button>
                        <button
                          onClick={applyList}
                          className="p-1 text-gray-600 hover:bg-gray-200 rounded"
                          title="List"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={List} alt="list" />
                        </button>
                        <button
                          onClick={applyList}
                          className="p-1 text-gray-600 hover:bg-gray-200 rounded"
                          title="Attach"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={Clip} alt="adjuntar" />
                        </button>
                        <button
                          onClick={applyList}
                          className="p-1 text-gray-600 hover:bg-gray-200 rounded"
                          title="Align Left"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={Left} alt="left" />
                        </button>
                        <button
                          onClick={applyList}
                          className="p-1 text-gray-600 hover:bg-gray-200 rounded"
                          title="Align Center"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={Center} alt="center" />
                        </button>
                        <button
                          onClick={applyList}
                          className="p-1 text-gray-600 hover:bg-gray-200 rounded"
                          title="Align Right"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={Right} alt="right" />
                        </button>
                        <button
                          onClick={applyList}
                          className="p-1 text-gray-600 hover:bg-gray-200 rounded"
                          title="Justify"
                        >
                          <img className="w-5 h-5 mr-[2px]" src={Justify} alt="justificado" />
                        </button>
                      </div>
                      <textarea
