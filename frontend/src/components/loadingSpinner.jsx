...
function LoadingSpinner() {
  return (
    <div
      id="sticky-banner"
      tabindex="-1"
      className="fixed flex w-auto justify-between p-4 border-b border-gray-300 bg-gray-100 dark:bg-gray-900 dark:border-gray-800"
    >
      <div className="flex items-center mx-auto">
        <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
          ...
          <span>
            Explore our tutorials to get the most out of the platform{" "}
            <a
              href="https://Stratrooms.com"
